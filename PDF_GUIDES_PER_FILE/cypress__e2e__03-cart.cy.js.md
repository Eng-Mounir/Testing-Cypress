# Detailed Guide - cypress/e2e/03-cart.cy.js

Generated on: 2026-03-23

## 1) File Overview

- File path: cypress/e2e/03-cart.cy.js
...
- Test name: [TC-015] Should add product to cart successfully
...
- Test name: [TC-016] Should add multiple quantities of same product
- Scenario note: No additional comment found.
- Expected behavior: The assertions in this test should validate the scenario above against the live UI.
- Reuse: This case can be reused as a regression test after UI or API updates.
...
- Test name: [TC-017] Should display all products in cart
- Scenario note: No additional comment found.
- Expected behavior: The assertions in this test should validate the scenario above against the live UI.
- Reuse: This case can be reused as a regression test after UI or API updates.
...
- Test name: [TC-018] Should update product quantity in cart
- Scenario note: No additional comment found.
- Expected behavior: The assertions in this test should validate the scenario above against the live UI.
- Reuse: This case can be reused as a regression test after UI or API updates.
...
- Test name: [TC-019] Should remove product from cart
- Scenario note: No additional comment found.
- Expected behavior: The assertions in this test should validate the scenario above against the live UI.
- Reuse: This case can be reused as a regression test after UI or API updates.
...
- Test name: [TC-020] Should calculate correct cart total with multiple products
- Scenario note: No additional comment found.
- Expected behavior: The assertions in this test should validate the scenario above against the live UI.
- Reuse: This case can be reused as a regression test after UI or API updates.
...
- Test name: [TC-021] Should return to products page from cart
- Scenario note: No additional comment found.
- Expected behavior: The assertions in this test should validate the scenario above against the live UI.
- Reuse: This case can be reused as a regression test after UI or API updates.
...
describe("Shopping Cart Tests", () => {
  ...
  it("[TC-019] Should remove product from cart", function () {
    ...
    // Assertion 2: Cart table or empty state is shown
